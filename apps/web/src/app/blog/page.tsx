        ...
        {posts.map((post) => {
          ...
          return (
            ...
            >
                ...
                <div className="z-10">
                  <p>
                    <time
                      ...
                      dateTime={post.createdAt as string}
                      itemProp="datePublished"
                    >
                      {formatBlogDateShort(post.createdAt as string)}
                    </time>
                  </p>
                  <h3 className="my-2 font-bold leading-tight">{post.tagline}</h3>
                  <h2
              ...
              <Link
                className="block rounded-xl bg-black px-4 py-2 font-bold text-white hover:bg-gray-700"
                href={`/blog/${post.slug}`}
              >
                Continue reading
              </Link>
