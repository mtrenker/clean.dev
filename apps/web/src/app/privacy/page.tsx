        ...
        <div className="space-y-8">
          ...
          <section className="border-t border-border pt-4">
            <p className="text-xs text-muted-foreground">
              ...
              {intl.formatMessage({ id: 'privacy.updated.body.beforeLink' })}{' '}
              <Link href="/imprint" className="text-accent hover:underline">
                {intl.formatMessage({ id: 'privacy.updated.body.link' })}
              </Link>{' '}
              {intl.formatMessage({ id: 'privacy.updated.body.afterLink' })}
            </p>
          </section>
        </div>
      </Container>
