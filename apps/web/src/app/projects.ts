...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: {
      en: 'Contract extended with broader scope across the CRM backend landscape. Extended the existing production TypeScript/Node.js API built with NestJS and Express, designed and shipped a unified C#/.NET API (REST + GraphQL), and introduced governed AI tooling for daily delivery work.',
      de: 'Vertragsverlängerung mit erweitertem Scope in der CRM-Backend-Landschaft. Weiterentwicklung der bestehenden produktiven TypeScript-/Node.js-API mit NestJS und Express, Konzeption und Umsetzung einer einheitlichen C#/.NET-API (REST + GraphQL) sowie Einführung von KI-Tooling mit klaren Leitplanken für die tägliche Arbeit.',
    },
    city: 'Düsseldorf',
    highlights: {
      en: [
        ...
        'built a Node.js/TypeScript agent CLI giving AI agents governed access to Jira, Confluence, Azure DevOps, and internal tooling, with human review of all output',
      ...
      de: [
        ...
        'produktives CRM-Backend in TypeScript/Node.js mit NestJS und Express weiterentwickelt und gewartet, darunter API-Endpunkte, Konfiguration und externe Service-Integrationen',
        ...
        'Node.js-/TypeScript-Agent-CLI gebaut, das KI-Agenten kontrollierten Zugriff auf Jira, Confluence, Azure DevOps und interne Tools gibt – mit menschlichem Review aller Ergebnisse',
