  ...
  return (
    <html lang={locale}>
      ...
      <body className={`${fontSans.variable} ${fontMono.variable} ${fontSerif.variable} pb-20 font-sans antialiased md:pb-0`}>
        ...
        <a
          href="#main-content"
          className="fixed left-2 top-2 z-[9999] -translate-y-20 rounded-sm bg-accent px-4 py-2 text-sm font-semibold text-accent-foreground shadow-lg transition-transform focus:translate-y-0 print:hidden"
        >
