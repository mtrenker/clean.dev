...
export const LanguageSwitcher: React.FC<LanguageSwitcherProps> = ({ currentLocale }) => {
  ...
  return (
    <div
      className="flex items-center gap-1 rounded-full border border-[var(--site-rule)] bg-[var(--site-panel)] p-1 text-xs shadow-[0_12px_40px_rgba(0,0,0,0.18)]"
        ...
        <button
          ...
          className={[
            ...
            locale === currentLocale
              ? 'bg-[var(--site-rust)] !text-[var(--site-bg)] shadow-[0_0_0_1px_rgba(217,110,63,0.34)]'
